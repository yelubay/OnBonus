...
$username = "root";
$password = "";
$connection = mysqli_connect($dbServername, $username, $password, $db);
...
if(isset($_POST["action"]) ){
  if($_POST['filter'] == 'All'){
    ...
    $sql = "SELECT * FROM News WHERE Author < 1000";
    }
    else if($_POST['filter'] == 'A'){
    $sql = "SELECT * FROM News WHERE Author > 1000 and Author < 2000";}
    else if($_POST['filter'] == 'R'){
    $sql = "SELECT * FROM News WHERE Author > 2000";}
 ...
 <footer style="margin-top: 10px; margin-bottom: 50px;">
    <div class="container">
      <div class="row">
        <div class="col-md-4">
