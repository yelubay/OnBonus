...
<?php
       ...
       $result = mysqli_query($conn, $sql);
        while ($row = mysqli_fetch_array($result)) {
            echo '<div class="item active" style="height:800px; margin-top:110px;">
...
<div class="container-fluid">  
    <div class="row content col-sm-12"  style="margin-bottom:100px;">
        <div class="col-lg-9 col-sm-9">
            <p  style="color:black; padding:0 10px 0 10px; font-size:18px;">Price: '.$row["Author"].'</p>
...
if(isset($_SESSION['u_username'])) {
    ...
    echo "Вы должны <a href='Signin.php' style='color: #FF025D;'>Войти</a> чтобы оставить отзыв<br><br>
    <input type='hidden' name='title' id='titlename' value='".$_GET['q']."'>";
}
